...
export default function BrandProductsPage() {
  ...
  if (!brandName) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        <h1 className="text-3xl font-bold mb-4 text-gray-900 dark:text-white">Brand Not Found</h1>
        <p className="mb-8 text-gray-600 dark:text-gray-400">The brand you&apos;re looking for doesn&apos;t exist.</p>
        <LocalizedLink
          href="/products"
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h1 className="text-3xl font-bold mb-8 text-gray-900 dark:text-white">{brandName} Products</h1>
